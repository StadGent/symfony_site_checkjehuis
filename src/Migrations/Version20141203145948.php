...
class Version20141203145948 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE build_costs (id INT AUTO_INCREMENT NOT NULL, ordering INT NOT NULL, slug VARCHAR(255) NOT NULL, `label` VARCHAR(255) NOT NULL, value DOUBLE PRECISION NOT NULL, unit VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE config_choices (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, ordering INT NOT NULL, `label` VARCHAR(255) NOT NULL, `default` TINYINT(1) NOT NULL, defaultUpToYear VARCHAR(255) DEFAULT NULL, possibleCurrent TINYINT(1) NOT NULL, possibleUpgrade TINYINT(1) NOT NULL, costFactor DOUBLE PRECISION NOT NULL, co2Factor DOUBLE PRECISION NOT NULL, relatedCost_id INT DEFAULT NULL, INDEX IDX_70D254C912469DE2 (category_id), INDEX IDX_70D254C987FD23C6 (relatedCost_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE subsidies (id INT AUTO_INCREMENT NOT NULL, slug VARCHAR(255) NOT NULL, `label` VARCHAR(255) NOT NULL, value DOUBLE PRECISION NOT NULL, multiplier VARCHAR(255) NOT NULL, max INT DEFAULT NULL, subsidyCategory_id INT DEFAULT NULL, INDEX IDX_ECEE6C4AD75064B4 (subsidyCategory_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
